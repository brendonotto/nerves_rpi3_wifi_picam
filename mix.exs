defmodule NervesRpi3WifiPicam.MixProject do
  use Mix.Project
  ...
  # invoke NervesRpi3WifiPicam.start/2 when running on a target.
  ...
  def application(_target) do
    [
      mod: {NervesRpi3WifiPicam.Application, []},
